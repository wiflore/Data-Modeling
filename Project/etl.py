...
def process_song_file(cur, filepath):
    ...
    artist_data =  df[columns].values[0]
    cur.execute(artist_table_insert, artist_data)


def process_log_file(cur, filepath):
    # perform ETL on dataset log_data to create the time and users dimensional tables, 
...
def process_data(cur, conn, filepath, func):
    #Get all the datasets and process the files
